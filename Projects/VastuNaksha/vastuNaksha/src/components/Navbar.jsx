        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:block shrink-0 preserve-3d">
            <button
              ...
              className="group relative px-8 py-4 bg-[#25D366] text-white rounded-3xl font-bold text-lg transition-all duration-500 hover:scale-110 hover:shadow-2xl active:scale-95 focus:outline-none focus:ring-4 focus:ring-[#25D366]/50 shadow-lg preserve-3d hover-3d overflow-hidden"
            >
              <span className="relative z-10 flex items-center gap-3 font-['Gilroy']">
              ...
              <div className="absolute inset-0 bg-linear-to-r from-[#128C7E] to-[#25D366] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-3xl preserve-3d"></div>
              <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-20 transition-opacity duration-300 rounded-3xl blur-xl -z-10 preserve-3d"></div>
              <div className="absolute -inset-1 bg-[#25D366]/30 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-lg -z-20 preserve-3d"></div>
            </button>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-6 shadow-3d-lg preserve-3d">
              <div className="space-y-4 preserve-3d">
                ...
                <div className="pt-4 border-t border-white/30 preserve-3d">
                  <button
                    onClick={() => setShowWhatsAppModal(true)}
                    className="group relative w-full px-8 py-4 bg-[#25D366] text-white rounded-3xl font-bold text-lg hover:scale-105 hover:shadow-2xl active:scale-95 transition-all duration-300 flex items-center justify-center gap-3 shadow-lg preserve-3d hover-3d overflow-hidden"
                  >
                    <div className="relative">
                      <svg
                        className="w-6 h-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12"
